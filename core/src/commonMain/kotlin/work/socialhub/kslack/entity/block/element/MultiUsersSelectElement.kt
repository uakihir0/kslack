...
class MultiUsersSelectElement : BlockElement {
    ...
    override fun equals(o: Any): Boolean {
        ...
        if (o !is MultiUsersSelectElement) return false
        val other = o
        ...
        val `this$initialUsers`: Any? = this.initialUsers
        val `other$initialUsers`: Any? = other.initialUsers
        if (if (`this$initialUsers` == null) `other$initialUsers` != null else `this$initialUsers` != `other$initialUsers`) return false
    ...
    protected fun canEqual(other: Any?): Boolean {
        return other is MultiUsersSelectElement
    }
    ...
    override fun hashCode(): Int {
        ...
        val `$initialUsers`: Any? = this.initialUsers
        result = result * PRIME + (`$initialUsers`?.hashCode() ?: 43)
    ...
    class MultiUsersSelectElementBuilder internal constructor() {
        ...
        fun fallback(fallback: String?): MultiUsersSelectElementBuilder {
            this.fallback = fallback
            return this
        }

        fun placeholder(placeholder: PlainTextObject?): MultiUsersSelectElementBuilder {
            this.placeholder = placeholder
            return this
        }

        fun actionId(actionId: String?): MultiUsersSelectElementBuilder {
            this.actionId = actionId
            return this
        }
        ...
        fun confirm(confirm: ConfirmationDialogObject?): MultiUsersSelectElementBuilder {
            this.confirm = confirm
            return this
        }

        fun maxSelectedItems(maxSelectedItems: Int?): MultiUsersSelectElementBuilder {
            this.maxSelectedItems = maxSelectedItems
            return this
        }

        fun build(): MultiUsersSelectElement {
            return MultiUsersSelectElement(fallback, placeholder, actionId, initialUsers, confirm, maxSelectedItems)
        }
    ...
    companion object {
        ...
        fun builder(): MultiUsersSelectElementBuilder {
            return MultiUsersSelectElementBuilder()
        }
    }
}
