...
/**
 * https://api.slack.com/methods/admin.conversations.disconnect
 */
@JsExport
class AdminConversationsDisconnectRequest(
    override var token: String?,
    /** The ID of the channel in the local workspace. */
    var channelId: String,
    /** The ID of the workspace to disconnect the channel from. */
